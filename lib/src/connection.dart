...
class ConnectionImpl implements Connection {
  ...
  Future connect(
    ...
    _reader = new PacketReader(new DataReader(_socket), clientCapabilityFlags: _clientCapabilityFlags);
    _writer = new DataWriter(_socket);

    var initialHandshakePacket = await _reader.readInitialHandshakePacket();

    _reader.serverCapabilityFlags = initialHandshakePacket.serverCapabilityFlags;
